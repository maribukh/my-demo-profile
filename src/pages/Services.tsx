...
export default function Services() {
  ...
  const handleCustomOrder = () => {
    setSelectedService({
      ...
      msg: "Hi Mariam, I have a custom project in mind. Here are the details...",
    });
  };
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="text-center md:text-left max-w-xl">
                ...
                <p className="text-gray-400 mb-6 text-lg">
                  If you need something specific that isn't listed above, feel
                  free to discuss it. I am open to new ideas and challenges.
                </p>
              ...
              <div className="flex flex-col items-center gap-4">
                <span className="text-sm font-semibold text-neonBlue uppercase tracking-widest">
                  Quick Chat
                </span>
