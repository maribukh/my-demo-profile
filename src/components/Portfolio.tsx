...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      desc: {
        en: 'Group project for University. My role: Core Frontend Developer. I led the UI implementation, managed Git merge conflicts, and integrated backend APIs.',
        ka: 'გუნდური პროექტი BTU-ში. ჩემი როლი: Front-End დეველოპერი. პასუხისმგებელი ვიყავი UI-ის აწყობაზე, API ინტეგრაციასა და Git ნაკადების მართვაზე.',
        ru: 'Командный проект в BTU. Моя роль: Front-End разработчик. Отвечала за верстку UI, интеграцию API и решение конфликтов слияния в Git.',
      },
    },
  ];
