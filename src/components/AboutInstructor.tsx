      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="flex flex-col items-center justify-center mb-10">
          <div className="relative w-56 h-56 md:w-64 md:h-64 flex items-center justify-center">
            ...
            <div className="relative w-[96%] h-[96%] rounded-full bg-[#050505] p-1 overflow-hidden z-10">
              {instructor.imageUrl ? (
                <img
                  alt={instructor.name}
                ...
                <div className="flex-1 hidden md:flex justify-start">
                  {index === 0 && (
                    <div className="w-full relative group">
                      <div className="absolute -inset-0.5 bg-gradient-to-r from-green-500 to-neonBlue rounded-xl blur opacity-30 group-hover:opacity-75 transition duration-1000 animate-pulse"></div>

                      <div className="relative bg-[#0A0A0F] border border-white/10 rounded-xl p-6 h-full flex flex-col justify-between hover:border-green-500/50 transition-all">
                        <div className="flex justify-between items-start mb-4">
                          <div>
                            <h4 className="text-xs uppercase tracking-[0.2em] text-gray-500 font-orbitron mb-1">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-white font-bold font-orbitron text-lg tracking-wide">
                                {t.instructor.status.available}
                              </span>
                            </div>
                          </div>
                          <div className="flex flex-col items-end">
                            <div className="flex items-center gap-2 text-xs text-gray-400 bg-white/5 px-2 py-1 rounded-md border border-white/5">
                        ...
                        <div className="space-y-3 mb-6">
                          ...
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-neonBlue/10 flex items-center justify-center text-neonBlue">
                        ...
                        <a
                          ...
                          className="w-full py-3 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-neonBlue/50 hover:text-white text-gray-300 flex items-center justify-center gap-2 transition-all group/btn"
                        >
