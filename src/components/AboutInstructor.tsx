...
export default function AboutInstructor() {
  ...
  // Логика выбора файла резюме в зависимости от языка
  const cvFile =
    language === 'ka'
      ? '/Mariam_Bukhaidze_CV_KA.pdf' // Убедись, что этот файл есть в папке public
      : '/Mariam_Bukhaidze_CV.pdf'; // Убедись, что этот файл есть в папке public
          ...
          <div className='space-y-12'>
            {instructor.experience.map((exp, index) => (
              ...
              >
                ...
                {/* Right Side: Status Card (only for first item) or Empty */}
